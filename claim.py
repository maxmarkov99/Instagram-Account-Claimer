...
class Instagram:
    ...
    def change_title(self):
        if clear == "cls":
            ctypes.windll.kernel32.SetConsoleTitleW(
                f"Instagram Auto Claimer | Attempts: {self.attempts} | Retries: {self.retries} | Proxy Errors: {self.proxy_errors} | Errors: {self.errors} | Developed by @maxmarkov99 on Github"
            )
    ...
    def main(self):
        os.system(clear)
        if clear == "cls":
            ctypes.windll.kernel32.SetConsoleTitleW("Instagram Auto Claimer | Developed by @maxmarkov99 on Github")
